...
FSRS6_COST_ADR_RETENTION_ACTION_SPACE = "sd_cost_retention_function"
...
LAMBDALESS_ACTION_SPACES = PORTFOLIO_CHILD_ACTION_SPACES | frozenset(
    {
        ...
        FSRS6_COST_ADR_RETENTION_ACTION_SPACE,
    }
)
...
_FSRS6_COST_ADR_ACTION_SPACES: dict[str, str] = {
    ...
    COST_ADR_FEATURE_VERSION_RETENTION_MONO: FSRS6_COST_ADR_RETENTION_ACTION_SPACE,
    COST_ADR_FEATURE_VERSION_RETENTION_MONO_DROP_SQRT_Z: FSRS6_COST_ADR_RETENTION_ACTION_SPACE,
    COST_ADR_FEATURE_VERSION_RETENTION_MONO_DROP_XD2: FSRS6_COST_ADR_RETENTION_ACTION_SPACE,
    COST_ADR_FEATURE_VERSION_RETENTION_MONO_DROP_SQRT_Z_XD2: FSRS6_COST_ADR_RETENTION_ACTION_SPACE,
    COST_ADR_FEATURE_VERSION_RETENTION_MONO_Z2_ONLY: FSRS6_COST_ADR_RETENTION_ACTION_SPACE,
}
