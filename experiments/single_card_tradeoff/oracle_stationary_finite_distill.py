...
class StationaryFiniteOracleGuide:
    def __init__(
        ...
        *,
        ...
        self.oracle = FSRS6StationaryFiniteOracle(
            days=days,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Distill the stationary finite-lifecycle FSRS-6 oracle into a UVFA policy."
        ),
        allow_abbrev=False,
    )
    ...
    parser.add_argument(
        ...
        default=Path(
            "artifacts/single_card_tradeoff/"
            "fsrs6_oracle_stationary_finite_distill_policy.pt"
        ),
    )
