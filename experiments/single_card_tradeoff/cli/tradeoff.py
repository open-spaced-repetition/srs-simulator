...
from experiments.single_card_tradeoff.models.single_card_env import FSRS6SingleCardBatch
from experiments.single_card_tradeoff.core.types import (
    BatchRow,
    SchedulerPoint,
    SimMetrics,
    UserContext,
...
def _load_uvfa_ppo_policy(
    ...
    *,
    ...
    return _load_policy_checkpoint(
        ...
        train_hint=(
            "Train one with `uv run python -m experiments.single_card_tradeoff.cli.uvfa_ppo "
...
def _load_fsrs6_oracle_distill_policy(
    ...
    *,
    ...
    return _load_policy_checkpoint(
        ...
        train_hint=(
            "Train one with `uv run python -m experiments.single_card_tradeoff.cli.oracle_distill "
    ...
    *,
    ...
    return _load_policy_checkpoint(
        ...
        train_hint=(
            ...
            "python -m experiments.single_card_tradeoff.cli.oracle_infinite_distill "
    ...
    *,
    ...
    if not args.oracle_retention_distill_policy.exists():
        raise SystemExit(
            ...
            "`uv run python -m experiments.single_card_tradeoff.cli.oracle_retention_distill "
            f"--model-out {args.oracle_retention_distill_policy}` or pass "
            "--oracle-retention-distill-policy."
        )

    from experiments.single_card_tradeoff.cli.oracle_retention_distill import (
        RetentionDistillNet,
    )
    ...
    *,
    ...
    if not args.uvfa_ppo_rnn_interval_policy.exists():
        raise SystemExit(
            ...
            "`uv run python -m experiments.single_card_tradeoff.cli.uvfa_ppo_rnn_interval --model-out "
            f"{args.uvfa_ppo_rnn_interval_policy}` or pass "
            "--uvfa-ppo-rnn-interval-policy."
        )

    from experiments.single_card_tradeoff.cli.uvfa_ppo_rnn_interval import (
    ...
    *,
    ...
    if not args.oracle_interval_distill_policy.exists():
        raise SystemExit(
            ...
            "`uv run python -m experiments.single_card_tradeoff.cli.oracle_interval_distill --model-out "
