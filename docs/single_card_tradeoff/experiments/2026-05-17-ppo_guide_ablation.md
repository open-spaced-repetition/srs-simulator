...
### Clipped same-target time saved AUC ablations

| variant | params | same_target_time_saved_auc | relative_time_saved | coverage |
| --- | --- | --- | --- | --- |
...
The oracle guide remains the safest PPO recipe in the current artifact set. Guide choice changes both time saved and frontier span, so coverage must be reported with AUC.
