...
| Stationary Finite Compression | `docs/single_card_tradeoff/experiments/2026-05-17-stationary_finite_compression.md` | The aligned 128-epoch rerun pushes the compact candidate to 316 parameters with 98.53% coverage. |
