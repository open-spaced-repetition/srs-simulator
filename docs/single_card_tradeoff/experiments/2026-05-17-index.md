...
| Stationary Finite Compression | `docs/single_card_tradeoff/experiments/2026-05-17-stationary_finite_compression.md` | The aligned 128-epoch rerun keeps a strong 316-parameter student; below 216 parameters, the best-regret row is `residual:5:1` at -20.00% +/- 0.34%. |
