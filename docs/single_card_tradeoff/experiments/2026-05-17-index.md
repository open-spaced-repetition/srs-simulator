...
| first-eight per-user distill | `docs/single_card_tradeoff/experiments/2026-05-17-first8_stationary_finite_distill.md` | Eight independent 476-parameter students average 12.36% relative time saved vs `fsrs6`. |
| first-eight exact vs distill | `docs/single_card_tradeoff/experiments/2026-05-17-first8_exact_vs_distill.md` | Direct distill-vs-exact relative time saved is 3.03% over 96.60% shared coverage. |
