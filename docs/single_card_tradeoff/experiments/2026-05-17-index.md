...
| Stationary finite train-weight 1/4 control | `docs/single_card_tradeoff/experiments/2026-05-20-distill_train_weights_1_4_control.md` | Adding `1,4` fixes user 2 and raises mean relative AUC to 11.79%, but user 7 regresses by 2.38 pp. |
