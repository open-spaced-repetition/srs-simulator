...
| first-eight residual:4:1 e512 | `docs/single_card_tradeoff/experiments/2026-05-18-first8_stationary_finite_r4d1_e512.md` | The 132-parameter per-user student reaches -10.67% relative regret at 95.52% coverage vs `fsrs6`. |
...
| UVFA PPO | `docs/single_card_tradeoff/experiments/2026-05-17-uvfa_ppo.md` | `uvfa_ppo` reaches -24.89% relative regret at 99.16% coverage, using 27,148 parameters. |
| Recurrent Interval PPO | `docs/single_card_tradeoff/experiments/2026-05-17-recurrent_interval_ppo.md` | `uvfa_ppo_rnn_interval` reaches -21.67% relative regret at 69.18% coverage, but uses 87,559 parameters. |
| Discrete Oracle Distillation | `docs/single_card_tradeoff/experiments/2026-05-17-oracle_distill.md` | `fsrs6_oracle_distill` is the strongest compact default baseline: -24.18% relative regret at 86.29% coverage. |
...
| Stationary Finite Epoch Extension | `docs/single_card_tradeoff/experiments/2026-05-18-stationary_finite_epoch_extension.md` | `residual:4:1` reaches -22.58% +/- 0.29% relative regret and 98.43% +/- 0.15% coverage at 512 epochs, but recovery is architecture-dependent. |
...
| Interval Oracle Distillation | `docs/single_card_tradeoff/experiments/2026-05-17-interval_oracle_distill.md` | Interval distill reaches -30.03% relative regret at 100.00% coverage in the rerun comparison. |
| Continuous Desired-Retention Distillation | `docs/single_card_tradeoff/experiments/2026-05-17-retention_distill.md` | `fsrs6_oracle_retention_distill` reaches -21.79% relative regret at 83.51% coverage. |
...
| Oracle Stationary Finite CPU/GPU Benchmark | `docs/single_card_tradeoff/experiments/2026-05-18-oracle_stationary_finite_cpu_gpu_benchmark.md` | Single-user: CPU 2.09x faster than CUDA; multi-user: CUDA 2.53x faster than CPU. |
