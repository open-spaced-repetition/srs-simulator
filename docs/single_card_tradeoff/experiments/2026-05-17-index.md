...
| Four-corner grid oracle | `docs/single_card_tradeoff/experiments/2026-05-22-oracle_four_corner_grid_first8.md` | After unifying transition kernels, `fsrs6_oracle` reaches 15.19% relative time saved and beats stationary finite in the aggregate. |
