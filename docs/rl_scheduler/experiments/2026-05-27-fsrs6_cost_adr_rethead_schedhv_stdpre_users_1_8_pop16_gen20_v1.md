# Cost ADR retention-head schedHV stdpre vs Cost ADR interval-head schedHV stdpre experiment report
...
- Cost ADR retention-head schedHV stdpre: `artifacts/rl_scheduler/fsrs6_cost_adr_rethead_schedhv_stdpre_users_1_8/fsrs6_cost_adr_rethead_schedhv_stdpre_users_1_8_pop16_gen20_v1_markov_off/analyze-pareto/analyze_pareto_outputs/analysis_summary.json`
...
| --- | --- | --- | --- |
| Cost ADR retention-head schedHV stdpre | analyze-pareto | yes | - |
| Cost ADR retention-head schedHV stdpre | build-pareto | yes | - |
| Cost ADR retention-head schedHV stdpre | preflight | yes | - |
| Cost ADR retention-head schedHV stdpre | stage-baseline | yes | - |
| Cost ADR retention-head schedHV stdpre | sweep | yes | - |
| Cost ADR retention-head schedHV stdpre | train-overfit | yes | - |
...
| --- | --- | --- | --- | --- | --- |
| Cost ADR retention-head schedHV stdpre | sweep | cuda | 46.6 | 313.3 | - |
| Cost ADR retention-head schedHV stdpre | train-overfit | cuda | 770.9 | 18.9 | 303.0 |
...
| --- | --- | --- | --- | --- | --- | --- |
| Cost ADR retention-head schedHV stdpre | b7b3f77777dd4ad9df64d2fc6d7ca160a018e82b | false | 3.13.11 | 2.9.1+cu126 | 12.6 | NVIDIA GeForce RTX 4090 D |
...
| --- | --- | --- | --- | --- | --- | --- |
| Cost ADR retention-head schedHV stdpre | sweep | `artifacts/rl_scheduler/fsrs6_cost_adr_rethead_schedhv_stdpre_users_1_8/fsrs6_cost_adr_rethead_schedhv_stdpre_users_1_8_pop16_gen20_v1_markov_off/sweep/gpu_monitor/summary.json` | 202.8 | 221.0 | False | 6,565.0 |
| Cost ADR retention-head schedHV stdpre | train-overfit | `artifacts/rl_scheduler/fsrs6_cost_adr_rethead_schedhv_stdpre_users_1_8/fsrs6_cost_adr_rethead_schedhv_stdpre_users_1_8_pop16_gen20_v1_markov_off/train-overfit/gpu_monitor/summary.json` | 407.2 | 425.5 | False | 6,555.0 |
...
Do not promote Cost ADR retention-head schedHV stdpre.

With the matched training budget, Cost ADR retention-head schedHV stdpre remains behind Cost ADR interval-head schedHV stdpre on HV; same-budget memory lift and same-target time saved deltas are:
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fsrs6 | Cost ADR retention-head schedHV stdpre | 72,551 | +2.347% | 118 | 90.2 | +1.376% | 88/112, 79.410% span | 3.62 | +10.741% | 85/112, 79.761% span |
...
| fsrs6 | Cost ADR retention-head schedHV stdpre - Cost ADR interval-head schedHV stdpre | -25,161 | -0.814% | -4 | -1.2 | -0.018% | -2, -7.727 pp span | -1.06 | -2.051% | -1, -2.570 pp span |
| lstm | Cost ADR retention-head schedHV stdpre | 8,907 | +0.277% | 120 | 47.7 | +0.730% | 87/114, 81.902% span | -2.17 | +1.918% | 91/114, 89.814% span |
| lstm | Cost ADR interval-head schedHV stdpre | 40,052 | +1.244% | 118 | 52.9 | +0.814% | 89/114, 86.716% span | 0.85 | +4.590% | 91/114, 91.662% span |
| lstm | Cost ADR retention-head schedHV stdpre - Cost ADR interval-head schedHV stdpre | -31,145 | -0.967% | 2 | -5.2 | -0.084% | -2, -4.814 pp span | -3.01 | -2.672% | +0, -1.848 pp span |

## Per-User HV Delta

Candidate-minus-comparison per-user HV delta is negative for 12/16 environment-user rows.

| user | fsrs6 Cost ADR retention-head schedHV stdpre HV delta | fsrs6 Cost ADR interval-head schedHV stdpre HV delta | fsrs6 delta | lstm Cost ADR retention-head schedHV stdpre HV delta | lstm Cost ADR interval-head schedHV stdpre HV delta | lstm delta |
| --- | --- | --- | --- | --- | --- | --- |
...
| --- | --- | --- | --- | --- | --- |
| fsrs6 | Cost ADR retention-head schedHV stdpre | 6,352.2 | 53.14 | 27.25 | 193.08 |
| fsrs6 | Cost ADR interval-head schedHV stdpre | 6,398.3 | 58.47 | 27.25 | 229.47 |
| lstm | Cost ADR retention-head schedHV stdpre | 6,241.0 | 65.03 | 24.44 | 251.64 |
...
| --- | --- | --- |
| Cost ADR retention-head schedHV stdpre | 1 | 9,857 |
| Cost ADR retention-head schedHV stdpre | 2 | 14,022 |
| Cost ADR retention-head schedHV stdpre | 3 | 3,242 |
| Cost ADR retention-head schedHV stdpre | 4 | 31,194 |
| Cost ADR retention-head schedHV stdpre | 5 | 7,160 |
| Cost ADR retention-head schedHV stdpre | 6 | 3,382 |
| Cost ADR retention-head schedHV stdpre | 7 | 1,478 |
| Cost ADR retention-head schedHV stdpre | 8 | 2,338 |
...
| --- | --- | --- |
| Cost ADR retention-head schedHV stdpre | 8 | 72,673 |
