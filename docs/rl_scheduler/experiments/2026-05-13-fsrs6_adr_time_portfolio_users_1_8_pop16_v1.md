...
- The FSRS6 gain is marginal, while the LSTM regression is material on both HV and regret.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fsrs6 | ADR time | 97,400 | +3.501% | 128 | 104.2 | +1.552% | 83/115, 79.851% span | -4.62 | -13.532% | 80/115, 77.083% span |
...
| lstm | ADR time | 48,430 | +1.705% | 125 | 76.9 | +1.159% | 79/111, 82.098% span | -0.96 | -2.152% | 80/111, 82.908% span |
