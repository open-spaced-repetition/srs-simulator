...
That family now has its own formal stage runner at `experiments.single_card_tradeoff.cli.run_experiment`, which reads semantic task tables instead of raw `[[commands]]` blocks.
