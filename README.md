...
Single-card lifecycle tradeoff experiments have their own guide in [`experiments/single_card_tradeoff/README.md`](experiments/single_card_tradeoff/README.md).
