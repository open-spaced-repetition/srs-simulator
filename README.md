...
uv run python experiments/retention_sweep/run_sweep_users_batched.py --config experiments/retention_sweep/configs/sa_fsrs6_dr_external_lstm_users_1_8.toml --dry-run
